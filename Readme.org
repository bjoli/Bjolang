...
Currently the cursors api does double decoding, since going one char forward means we have to decode one whole 32bit unicode codepoint. This is sad. 

do literal hoisting of regular expressiosn.
